...
function HttSettings(): React.JSX.Element {
  ...
  const [translationExpanded, setTranslationExpanded] = React.useState(
  ...
  if (loading) {
    return (
      <div className="htt-panel">
        <div className="htt-panel-header">
          <h3>Hold-to-Transcribe</h3>
        </div>
  ...
  return (
    <div className="htt-panel">
      ...
      <div className="htt-panel-header">
        <h3>Hold-to-Transcribe</h3>
        <span
          className={`htt-status-badge ${settings.enabled ? 'htt-badge-active' : 'htt-badge-inactive'}`}
        >
      ...
      <div className="htt-toggle-row">
        <span className="htt-toggle-text">Enable Hold-to-Transcribe</span>
      ...
      {settings.enabled && (
        <>
          {/* ── Shortcut section ── */}
          <div className="htt-section">
            <h4 className="htt-section-title">Shortcut</h4>
            <div className="setting-group">
              <label htmlFor="htt-mode-select">Mode</label>
              <select
                id="htt-mode-select"
          ...
          <div className="htt-section">
            <h4 className="htt-section-title">Transcription</h4>
            ...
            <div className="setting-group">
              ...
              {!isModelDownloaded && settings.model && (
                <p className="htt-model-warning">
                  Model &quot;{settings.model}&quot; is not downloaded. Use the Model section above
                  to download it.
                </p>
              )}
            </div>
            ...
            <div className="htt-toggle-row">
              <span className="htt-toggle-text">Auto-paste into focused input</span>
              <label className="toggle-switch">
                <input
                  type="checkbox"
                  role="switch"
            ...
            <div className="htt-toggle-row">
              <div className="htt-toggle-row-info">
                <span className="htt-toggle-text">Translate to English</span>
                <span className="htt-toggle-description">
          ...
          <div className="htt-section-collapsible">
            <div
              className="htt-section-header"
              role="button"
              tabIndex={0}
            ...
            >
              <h4 className="htt-section-title">Translation</h4>
              <div className="htt-section-header-right">
                <label
                ...
                >
                  <input
                    ...
                    onChange={(e: ChangeEvent<HTMLInputElement>) => {
                      ...
                      if (e.target.checked) setTranslationExpanded(true);
                    }}
                  />
                  <span className="toggle-slider" />
                </label>
                <span className={`htt-chevron ${translationExpanded ? 'htt-chevron-open' : ''}`}>
                  &#x25BE;
                </span>
              </div>
            </div>
            ...
            <div
              className={`htt-section-body ${translationExpanded ? 'htt-section-body-open' : ''}`}
            >
              <div className="htt-section-body-inner">
                <p className="htt-hint" style={{ marginTop: 0, marginBottom: 10 }}>
                ...
                <div className="setting-group">
                  <button
                    ...
                    onClick={async () => {
                      ...
                      setTestResult(null);
                      const result = await window.electronAPI?.testTranslation(
